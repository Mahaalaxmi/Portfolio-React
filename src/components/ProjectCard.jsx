    ...
    try {
      ...
      if (response.status === 200) {
        ...
        toast("Project updated !", {
          className:
            "bg-gradient-to-r from-blue-500 to-teal-500 rounded-lg shadow-lg text-white p-3 flex gap-5 text-lg font-bold",
          icon: <Check />,
        });
        fetchprojects();
      }
        ...
        <div className="w-full h-auto flex justify-center items-center">
          <div className="w-[70] flex justify-start h-full items-center gap-1 ">
            <a
              href={link}
              target="_blank"
              className="overflow-x-visible relative w-12 h-12 overflow-y-clip group text-center hover:bg-blue-500/20 rounded-sm hover:border-b-2 hover:border-blue-500"
            >
            ...
            <div
              className="overflow-x-visible relative w-12 h-12 overflow-y-clip group text-center  hover:bg-red-500/20 rounded-sm hover:border-b-2 hover:border-red-500"
              onClick={() => {
                handledelete(id);
              }}
            >
          ...
          <p
            ...
            className="text-5xl font-bold self-end  px-4 w-[25%]"
          >
            {kid}
          </p>
        </div>
        ...
        <>
          <div className="h-screen w-screen absolute top-0 left-0 bg-black/20 flex justify-center items-center z-50">
            <div className=" h-[80%] w-[30%] bg-red z-50 flex flex-col  bg-white  shadow-lg ">
              <div className="w-full h-[35%] flex flex-row justify-start px-10 items-center border-2 text-blue-500 bg-white text-xl font-bold shadow-sm">
